...
object HwachaElementInstructions {
  ...
  def VMERGE             = BitPat("b???00000000000000000001?????????????????????????????011000111111")
  def VMIN               = BitPat("b???00000000000000000010?????????????????????????????011000111111")
  def VMAX               = BitPat("b???00000000000000000011?????????????????????????????011000111111")
  def VCLIP              = BitPat("b???00000000000000000100?????????????????????????????011000111111")
  ...
  def VMADD              = BitPat("b???00000001000000000001?????????????????????????????011000111111")
  def VMSUB              = BitPat("b???00000001000000000010?????????????????????????????011000111111")
