...
object HwachaInstructions {
  ...
  def VSETXRM            = BitPat("b000001000000?????110?????0001011")
  def VSETXSAT           = BitPat("b000001100000?????110?????0001011")
  def VGETXRM            = BitPat("b00000100000000000100?????0001011")
  def VGETXSAT           = BitPat("b00000110000000000100?????0001011")
...
object HwachaElementInstructions {
  ...
  def VLDSEGD            = BitPat("b1001???000000000???011000000000?000?????????????????101110111111")
  def VLDSEGW            = BitPat("b1001???000000000???010000000000?000?????????????????101110111111")
  def VLDSEGWU           = BitPat("b1001???000000000???110000000000?000?????????????????101110111111")
  def VLDSEGH            = BitPat("b1001???000000000???001000000000?000?????????????????101110111111")
  def VLDSEGHU           = BitPat("b1001???000000000???101000000000?000?????????????????101110111111")
  def VLDSEGB            = BitPat("b1001???000000000???000000000000?000?????????????????101110111111")
  def VLDSEGBU           = BitPat("b1001???000000000???100000000000?000?????????????????101110111111")
  def VLSMD              = BitPat("b1000000100000000???0111000??????000?????????????????101110111111")
  def VLSMW              = BitPat("b1000000100000000???0101000??????000?????????????????101110111111")
  def VLSMWU             = BitPat("b1000000100000000???1101000??????000?????????????????101110111111")
  def VLSMH              = BitPat("b1000000100000000???0011000??????000?????????????????101110111111")
  def VLSMHU             = BitPat("b1000000100000000???1011000??????000?????????????????101110111111")
  def VLSMB              = BitPat("b1000000100000000???0001000??????000?????????????????101110111111")
  def VLSMBU             = BitPat("b1000000100000000???1001000??????000?????????????????101110111111")
  def VLDSMD             = BitPat("b1001???100000000???0111000??????000?????????????????101110111111")
  def VLDSMW             = BitPat("b1001???100000000???0101000??????000?????????????????101110111111")
  def VLDSMWU            = BitPat("b1001???100000000???1101000??????000?????????????????101110111111")
  def VLDSMH             = BitPat("b1001???100000000???0011000??????000?????????????????101110111111")
  def VLDSMHU            = BitPat("b1001???100000000???1011000??????000?????????????????101110111111")
  def VLDSMB             = BitPat("b1001???100000000???0001000??????000?????????????????101110111111")
  def VLDSMBU            = BitPat("b1001???100000000???1001000??????000?????????????????101110111111")
  def VSSMD              = BitPat("b1000000100000000???0111000??????000?????????????????111110111111")
  def VSSMW              = BitPat("b1000000100000000???0011000??????000?????????????????111110111111")
  def VSSMH              = BitPat("b1000000100000000???0101000??????000?????????????????111110111111")
  def VSSMB              = BitPat("b1000000100000000???0001000??????000?????????????????111110111111")
  ...
  def VFVMMADD_S         = BitPat("b???????0000???1?????????????????????????????????????100000111111")
  ...
  def VFVMMADD_D         = BitPat("b???????0101???1?????????????????????????????????????100000111111")
  ...
  def VFVMMADD_H         = BitPat("b???????1010???1?????????????????????????????????????100000111111")
  ...
  def VLDD               = BitPat("b1001???000000000000011000000000?000?????????????????101110111111")
  def VLDW               = BitPat("b1001???000000000000010000000000?000?????????????????101110111111")
  def VLDWU              = BitPat("b1001???000000000000110000000000?000?????????????????101110111111")
  def VLDH               = BitPat("b1001???000000000000001000000000?000?????????????????101110111111")
  def VLDHU              = BitPat("b1001???000000000000101000000000?000?????????????????101110111111")
  def VLDB               = BitPat("b1001???000000000000000000000000?000?????????????????101110111111")
  def VLDBU              = BitPat("b1001???000000000000100000000000?000?????????????????101110111111")
