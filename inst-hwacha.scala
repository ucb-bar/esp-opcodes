...
object HwachaInstructions {
  ...
  def VMSS               = BitPat("b000001000????????010?????0101011")
  def VMSA               = BitPat("b000001100000?????010?????0101011")
...
object HwachaElementInstructions {
  ...
  def VFIRST             = BitPat("b0010000001111000000000000000000?????????????????????011000111111")
  ...
  def VPS                = BitPat("b10000000000000100000000000000000000?????0000????0000111100111111")
  ...
  def VFSQRT_D           = BitPat("b??000000001???00000101100000000?????????????????????101000111111")
  ...
  def VFCVT_D_H          = BitPat("b??000000010???00000100000000000?????????????????????101000111111")
  def VFCVT_H_D          = BitPat("b??000001000???00000100000000000?????????????????????101000111111")
  def VFCVT_S_H          = BitPat("b??000000110???00000100000000000?????????????????????101000111111")
  def VFCVT_H_S          = BitPat("b??000001001???00000100000000000?????????????????????101000111111")
  ...
  def VPCLEAR            = BitPat("b1000010000000010000????0000????00000????0000????0000011000111111")
  def VPSET              = BitPat("b1000011111111110000????0000????00000????0000????0000011000111111")
