...
object HwachaElementInstructions {
  ...
  def VLSSEGD            = Bits("b00000000000???00000011000000000?????????????????0000101100111111")
  def VLSSEGW            = Bits("b00000000000???00000010000000000?????????????????0000101100111111")
  def VLSSEGWU           = Bits("b00000000000???00000110000000000?????????????????0000101100111111")
  def VLSSEGH            = Bits("b00000000000???00000001000000000?????????????????0000101100111111")
  def VLSSEGHU           = Bits("b00000000000???00000101000000000?????????????????0000101100111111")
  def VLSSEGB            = Bits("b00000000000???00000000000000000?????????????????0000101100111111")
  def VLSSEGBU           = Bits("b00000000000???00000100000000000?????????????????0000101100111111")
  def VSSSEGD            = Bits("b00000000000???000000110?????????????????000000000000111100111111")
  def VSSSEGW            = Bits("b00000000000???000000100?????????????????000000000000111100111111")
  def VSSSEGH            = Bits("b00000000000???000000010?????????????????000000000000111100111111")
  def VSSSEGB            = Bits("b00000000000???000000000?????????????????000000000000111100111111")
  def VLASEGD            = Bits("b00000000001???00000011000000000?000?????????????0000101100111111")
  def VLASEGW            = Bits("b00000000001???00000010000000000?000?????????????0000101100111111")
  def VLASEGWU           = Bits("b00000000001???00000110000000000?000?????????????0000101100111111")
  def VLASEGH            = Bits("b00000000001???00000001000000000?000?????????????0000101100111111")
  def VLASEGHU           = Bits("b00000000001???00000101000000000?000?????????????0000101100111111")
  def VLASEGB            = Bits("b00000000001???00000000000000000?000?????????????0000101100111111")
  def VLASEGBU           = Bits("b00000000001???00000100000000000?000?????????????0000101100111111")
  def VSASEGD            = Bits("b00000000001???000000110?????????000?????000000000000111100111111")
  def VSASEGW            = Bits("b00000000001???000000100?????????000?????000000000000111100111111")
  def VSASEGH            = Bits("b00000000001???000000010?????????000?????000000000000111100111111")
  def VSASEGB            = Bits("b00000000001???000000000?????????000?????000000000000111100111111")
