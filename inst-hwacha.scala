...
object HwachaElementInstructions {
  ...
  def VPL                = Bits("b10000000000000100000000000000000000?????0000????0000101100111111")
  def VPS                = Bits("b10000000000000100000000000000000000?????0000????0000111100111111")
  ...
  def VPOP               = Bits("b100001????????10000????0000????00000????0000????0000011000111111")
  def VLSEGD             = Bits("b1000000000000000???011000000000?000?????????????????101100111111")
  def VLSEGW             = Bits("b1000000000000000???010000000000?000?????????????????101100111111")
  def VLSEGWU            = Bits("b1000000000000000???110000000000?000?????????????????101100111111")
  def VLSEGH             = Bits("b1000000000000000???001000000000?000?????????????????101100111111")
  def VLSEGHU            = Bits("b1000000000000000???101000000000?000?????????????????101100111111")
  def VLSEGB             = Bits("b1000000000000000???000000000000?000?????????????????101100111111")
  def VLSEGBU            = Bits("b1000000000000000???100000000000?000?????????????????101100111111")
  def VLSEGSTD           = Bits("b1000000000000000???0111000??????000?????????????????101100111111")
  def VLSEGSTW           = Bits("b1000000000000000???0101000??????000?????????????????101100111111")
  def VLSEGSTWU          = Bits("b1000000000000000???1101000??????000?????????????????101100111111")
  def VLSEGSTH           = Bits("b1000000000000000???0011000??????000?????????????????101100111111")
  def VLSEGSTHU          = Bits("b1000000000000000???1011000??????000?????????????????101100111111")
  def VLSEGSTB           = Bits("b1000000000000000???0001000??????000?????????????????101100111111")
  def VLSEGSTBU          = Bits("b1000000000000000???1001000??????000?????????????????101100111111")
  def VSSEGD             = Bits("b1000000000000000???011000000000?000?????????????????111100111111")
  def VSSEGW             = Bits("b1000000000000000???010000000000?000?????????????????111100111111")
  def VSSEGH             = Bits("b1000000000000000???001000000000?000?????????????????111100111111")
  def VSSEGB             = Bits("b1000000000000000???000000000000?000?????????????????111100111111")
  def VSSEGSTD           = Bits("b1000000000000000???0111000??????000?????????????????111100111111")
  def VSSEGSTW           = Bits("b1000000000000000???0101000??????000?????????????????111100111111")
  def VSSEGSTH           = Bits("b1000000000000000???0011000??????000?????????????????111100111111")
  def VSSEGSTB           = Bits("b1000000000000000???0001000??????000?????????????????111100111111")
  def VLSEGXD            = Bits("b1010000000000000???0110?????????????????????????????101100111111")
  def VLSEGXW            = Bits("b1010000000000000???0100?????????????????????????????101100111111")
  def VLSEGXWU           = Bits("b1010000000000000???1100?????????????????????????????101100111111")
  def VLSEGXH            = Bits("b1010000000000000???0010?????????????????????????????101100111111")
  def VLSEGXHU           = Bits("b1010000000000000???1010?????????????????????????????101100111111")
  def VLSEGXB            = Bits("b1010000000000000???0000?????????????????????????????101100111111")
  def VLSEGXBU           = Bits("b1010000000000000???1000?????????????????????????????101100111111")
  def VSSEGXD            = Bits("b1010000000000000???0110?????????????????????????????111100111111")
  def VSSEGXW            = Bits("b1010000000000000???0100?????????????????????????????111100111111")
  def VSSEGXH            = Bits("b1010000000000000???0010?????????????????????????????111100111111")
  def VSSEGXB            = Bits("b1010000000000000???0000?????????????????????????????111100111111")
  def VLSSEGD            = Bits("b0000000000000000???0110000000000????????????????0000101100111111")
  def VLSSEGW            = Bits("b0000000000000000???0100000000000????????????????0000101100111111")
  def VLSSEGWU           = Bits("b0000000000000000???1100000000000????????????????0000101100111111")
  def VLSSEGH            = Bits("b0000000000000000???0010000000000????????????????0000101100111111")
  def VLSSEGHU           = Bits("b0000000000000000???1010000000000????????????????0000101100111111")
  def VLSSEGB            = Bits("b0000000000000000???0000000000000????????????????0000101100111111")
  def VLSSEGBU           = Bits("b0000000000000000???1000000000000????????????????0000101100111111")
  def VSSSEGD            = Bits("b0000000000000000???0110????????0????????000000000000111100111111")
  def VSSSEGW            = Bits("b0000000000000000???0100????????0????????000000000000111100111111")
  def VSSSEGH            = Bits("b0000000000000000???0010????????0????????000000000000111100111111")
  def VSSSEGB            = Bits("b0000000000000000???0000????????0????????000000000000111100111111")
  def VLASEGD            = Bits("b0000000000000001???0110000000000000?????????????0000101100111111")
  def VLASEGW            = Bits("b0000000000000001???0100000000000000?????????????0000101100111111")
  def VLASEGWU           = Bits("b0000000000000001???1100000000000000?????????????0000101100111111")
  def VLASEGH            = Bits("b0000000000000001???0010000000000000?????????????0000101100111111")
  def VLASEGHU           = Bits("b0000000000000001???1010000000000000?????????????0000101100111111")
  def VLASEGB            = Bits("b0000000000000001???0000000000000000?????????????0000101100111111")
  def VLASEGBU           = Bits("b0000000000000001???1000000000000000?????????????0000101100111111")
  def VSASEGD            = Bits("b0000000000000001???0110????????0000?????000000000000111100111111")
  def VSASEGW            = Bits("b0000000000000001???0100????????0000?????000000000000111100111111")
  def VSASEGH            = Bits("b0000000000000001???0010????????0000?????000000000000111100111111")
  def VSASEGB            = Bits("b0000000000000001???0000????????0000?????000000000000111100111111")
  ...
  def VLAD               = Bits("b00000000000000010000110000000000000?????????????0000101100111111")
  def VLAW               = Bits("b00000000000000010000100000000000000?????????????0000101100111111")
  def VLAWU              = Bits("b00000000000000010001100000000000000?????????????0000101100111111")
  def VLAH               = Bits("b00000000000000010000010000000000000?????????????0000101100111111")
  def VLAHU              = Bits("b00000000000000010001010000000000000?????????????0000101100111111")
  def VLAB               = Bits("b00000000000000010000000000000000000?????????????0000101100111111")
  def VLABU              = Bits("b00000000000000010001000000000000000?????????????0000101100111111")
  def VSAD               = Bits("b00000000000000010000110????????0000?????000000000000111100111111")
  def VSAW               = Bits("b00000000000000010000100????????0000?????000000000000111100111111")
  def VSAH               = Bits("b00000000000000010000010????????0000?????000000000000111100111111")
  def VSAB               = Bits("b00000000000000010000000????????0000?????000000000000111100111111")
  def VPCLEAR            = Bits("b1000010000000010000????0000????00000????0000????0000011000111111")
  def VPSET              = Bits("b1000011111111110000????0000????00000????0000????0000011000111111")
  def VPXORXOR           = Bits("b1000010110100110000????0000????00000????0000????0000011000111111")
  def VPXOROR            = Bits("b1000010111110110000????0000????00000????0000????0000011000111111")
  def VPXORAND           = Bits("b1000010001010010000????0000????00000????0000????0000011000111111")
  def VPORXOR            = Bits("b1000010110101010000????0000????00000????0000????0000011000111111")
  def VPOROR             = Bits("b1000010111111110000????0000????00000????0000????0000011000111111")
  def VPORAND            = Bits("b1000010001010110000????0000????00000????0000????0000011000111111")
  def VPANDXOR           = Bits("b1000010101011010000????0000????00000????0000????0000011000111111")
  def VPANDOR            = Bits("b1000010101011110000????0000????00000????0000????0000011000111111")
  def VPANDAND           = Bits("b1000010000000110000????0000????00000????0000????0000011000111111")
}
